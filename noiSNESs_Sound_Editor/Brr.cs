...
namespace noiSNESs_SoundLib
{
    public sealed class Brr
    {
        ...
        // IMPORTANT NOTE
        //
        // This class its few more than a mere copy
        // and translation to C# made from the code
        // written by Bregalad in his BRRtools. All
        // the credit from this class goes to him.
        //------------------------------------------
        ...
        public static byte[] encodeBrr(WavFileHeader hdr, Int16[] samples, BrrEncoderOptions options)
        {
            ...
            //Initialization needed if the optins require it and any of the first 16 samples isn't zero
            if (options.beginFromSilence)
            {
    ...
    public sealed class BrrEncoderOptions
    {
        ...
        public bool beginFromSilence = true;    // Force the new brr to begin the waveform from silence
